...
Forks and redistributions must preserve AGPL-3.0 notices and provide corresponding source when required.
The code is open under AGPL-3.0; CES project identity and branding remain reserved for the original CES distribution.
