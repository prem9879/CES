...
[START OF OUTPUT]`,
  ...
  // ── 5. CES FAST — Hermes 4 405B instant stream ────────────────
  {
    id: 'hermes-fast',
